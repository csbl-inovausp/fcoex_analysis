...
coex_module_plots[sapply(coex_module_plots, is.null)] <- NULL
wrap_plots(coex_module_plots)
```
...
```{r}
library(patchwork)
p1 <- DimPlot(pbmc3k.final, group.by = "fcoex_TYROBP")
p2 <- DimPlot(pbmc3k.final)
